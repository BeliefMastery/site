export const ARCHETYPE_SPREAD = [
  ...
  },
  {
    ...
    "greekPantheon": "Ajax (Defence, Bravery, Honour)",
    "tarotCard": "Knight of Wands",
    "socialProportion": 1.5
  },
  {
    "name": "Alpha-Rho Male",
    ...
    "greekPantheon": "Minos (Judgment, Authority, Fairness)",
    "tarotCard": "Justice",
    "socialProportion": 1
  },
  {
    ...
    "greekPantheon": "Cronus (Devours His Own), Ares (Bloodthirsty War)",
    "tarotCard": "The Tower",
    "socialProportion": 0.5
  },
  {
    "name": "Beta Male",
  ...
  },
  {
    ...
    "greekPantheon": "Prometheus (Defier of the Gods, Visionary), Icarus (Aspiration, Ambition, Freedom, Risk) Hermes (Trickster, Occultist)",
  ...
  },
  {
    ...
    "greekPantheon": "Paris (Romantic, Love Beauty, Impulsiveness)",
  ...
  },
  {
    ...
    "greekPantheon": "Apollo (Seer, Poet, Healer), Orpheus (Mystic)",
  ...
  },
  {
    ...
    "greekPantheon": "Hermes (Cunning, Speed, Trickery)",
  ...
  },
  {
    ...
    "greekPantheon": "Hades (Powerful but Withdrawn), Dionysus (Mystical but Autonomous)",
  ...
  },
  {
    ...
    "greekPantheon": "Odysseus (Master Strategist, Deceiver, Survivor), Hades (Underworld Ruler)",
  ...
  },
  {
    ...
    "greekPantheon": "Orpheus (Musician, Poet, Romantic, but Tragic)",
  ...
  },
  {
    ...
    "greekPantheon": "Thanatos (Rebellion Through Destruction), Kronos (Revolutionary Overthrower)",
    "tarotCard": "Death",
    "socialProportion": 0.5
  },
  {
    ...
    "greekPantheon": "Eros (Love Without Power), Pan (Lustful, Animalistic but Socially Weak)",
  ...
  },
  {
    ...
    "greekPantheon": "Typhon (Chaos Embodied), Nyx (Void Night)",
    "tarotCard": "The Moon",
    "socialProportion": 1
  },
  {
    ...
    "greekPantheon": "Uranus (Cosmic Awareness, Beyond Mortality)",
    "tarotCard": "The World",
    "socialProportion": 0
  },
  {
...
export const ARCHETYPE_SPREAD_MAP = Object.fromEntries(ARCHETYPE_SPREAD.map(item => [item.name, item]));
