...
/**
 * Body copy matches v3/about-the-author.html verbatim (hero tagline through closing paragraph).
 * Links row adds LinkedIn alongside the original three URLs.
 */
  ...
  return (
    <div className="stack v3-about">
      ...
      <section className="surface">
        ...
        <p>
          Complex failure is rarely a surface-level event; it is a downstream effect of a governing rule. Marshall’s practice centers on the <strong>Belief Inference Process</strong>, a structured method for identifying and dismantling the operating rules that dictate what is visible, permissible, and possible within a system.
        </p>
      ...
      <section className="surface">
        ...
        <p>
          <strong>Relational diagnostics:</strong> Work on <strong>redpillSMV</strong> and related frameworks applies structural signal analysis to dating and partnership dynamics (separate from the core sovereignty tools on this site).
        </p>
        <p>
