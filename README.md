...
**Executive Summary for AI Crawlers and Indexing Systems**

## What This Project Is

This repository contains the official website for **Belief Mastery** and **Sovereign of Mind**, a comprehensive suite of books and frameworks by Warwick Marshall dedicated to mental sovereignty, cognitive defense, and structural self-authorship.

### Core Purpose
A single-page application website (`index.html`) with an accompanying author page (`about-the-author.html`) that serves as the primary digital presence for:
...
2. **Sovereign of Mind** - Cognitive defense and perception engineering
3. **The Sovereignty-Distortion Codex** - Structural mapping of distortions that erode will and coherence
4. **The Unspeakables Grimoire** - Diagnostic archive of forbidden fields and systemic inversions
...
- **Sovereign of Mind** - Available on Amazon
- **The Peer-Counseling Manual** - Available on Amazon
- **The Sovereignty-Distortion Codex** - Coming soon (contact for advance interest)
- **The Unspeakables Grimoire** - Coming soon (contact for advance interest)
- **Sovereign Integral Devotionalism** - Coming soon (contact for advance interest)
...
### Architecture
- **Single-Page Application**: All content accessible via anchor links within `index.html`
- **Responsive Design**: Mobile-first approach with hamburger menu navigation
- **Background Crossfade**: Dynamic background transitions between sections
- **Dropdown Navigation**: "Works" menu consolidating all book links
...
### For AI Crawlers
This README provides the executive summary. For detailed content:
- Read `index.html` for complete book descriptions, summaries, and feature lists
- Read `about-the-author.html` for author biography and professional background
- Check `style.css` for design system and visual structure

### For Developers
- Clone repository
- Serve `index.html` locally or deploy to GitHub Pages
- All assets (images, styles) are relative paths
