import{_ as e,c as t,d as n,f as r,g as i,h as a,l as o,m as s,p as c,s as l,t as u,u as d,v as f}from"./spa-engine-external-BwN7bktj.js";import{a as p,d as m,h,i as g,l as _,m as v,n as y,o as b,r as x,t as S,u as C}from"./spa-questionnaire-host-Do04SsN7.js";var w,T,E,D,O,k,A,j,M,N=class{constructor(e={}){u(this,e),this.currentSection=0,this.currentQuestionIndex=0,this.iqBracket=null,this.iqBracketSecondary=null,this.answers={},this.questionSequence=[],this.scores={dependency:0,attachment:0,sovereignty:0,cognitiveComplexity:0,driftRisk:0,layer2:0,layer3:0,layer4:0,layer5:0},this.preliminaryFilters={aiUsageFrequency:null,dependencyLevel:null,cognitiveLevel:null},this._allocationScoreDeltas={},this.reportComplete=!1,this.analysisData={timestamp:new Date().toISOString(),iqBracket:null,section1Results:{},section2Results:{},section3Results:{},section4Results:{},cognitiveBand:null,subclasses:[],attachmentMode:null,vulnerabilityRisks:[],sovereigntyScore:0,sovereignSplitPosition:null,allAnswers:{},questionSequence:[]},this.dataStore=new a(`sovereignty-assessment`),this.ui=y(this,{idle:{show:[`#introSection`,`#actionButtonsSection`],hide:[`#questionnaireSection`,`#resultsContainer`]},assessment:{show:[`#questionnaireSection`],hide:[`#introSection`,`#actionButtonsSection`,`#resultsContainer`]},results:{show:[`#resultsContainer`],hide:[`#introSection`,`#actionButtonsSection`,`#questionnaireSection`]}}),this.ready=this.init()}init(){try{return this.externalUI||this.attachEventListeners(),Promise.resolve(this.loadStoredData()).then(()=>{if(!this.externalUI&&this.shouldAutoGenerateSample())return this.generateSampleReport();g(this)})}catch(e){i.logError(e,`SovereigntyEngine.init`),i.showUserError(`Failed to initialize assessment. Please refresh the page.`)}}getQuestionContainer(){return this.externalUI?this._externalQuestionMount:document.getElementById(`questionContainer`)}mountExternalShell(e){e&&(e.innerHTML=`
