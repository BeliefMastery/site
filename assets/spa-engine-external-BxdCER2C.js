import{t as e}from"./preload-helper-Cn2LLw11.js";import{n as t}from"./index-COhMgriM.js";var n=new Map,r=null;function i(e){r=e}async function a(t,i=null){if(r&&(r.registerDataModule(t,i||t),r.markModuleLoading(t)),n.has(t))return r&&r.markModuleLoaded(t,n.get(t)),n.get(t);try{let i=t;t.startsWith(`./`)?i=t.replace(`./`,`../`):!t.startsWith(`/`)&&!t.startsWith(`http`)&&!t.startsWith(`.`)&&(i=`../`+t);let a=new URL(i,import.meta.url).href,o=await e(()=>import(a),[]);return n.set(t,o),r&&r.markModuleLoaded(t,o),o}catch(e){throw r&&r.markModuleFailed(t,e),console.error(`Failed to load data module: ${t}`,e),e}}var o={sanitizeHTML(e){if(typeof e!=`string`)return e;let t=document.createElement(`div`);return t.textContent=e,t.innerHTML},sanitizeForDisplay(e){if(typeof e==`string`)return this.sanitizeHTML(e);if(Array.isArray(e))return e.map(e=>this.sanitizeForDisplay(e));if(typeof e==`object`&&e){let t={};for(let[n,r]of Object.entries(e))t[n]=this.sanitizeForDisplay(r);return t}return e},safeInnerHTML(e,t){if(!e){console.warn(`SecurityUtils.safeInnerHTML: element is null or undefined`);return}if(typeof t!=`string`){console.warn(`SecurityUtils.safeInnerHTML: content is not a string`,typeof t),e.innerHTML=``;return}e.innerHTML=t},safeTemplate(e,t,n){if(!e||typeof t!=`function`){console.warn(`SecurityUtils.safeTemplate: invalid arguments`);return}let r=t(this.sanitizeForDisplay(n));e.innerHTML=this.sanitizeHTML(r)}},s=class{constructor(e){this.namespace=e,this.version=`1.0.0`}save(e,n){try{let r={version:this.version,timestamp:Date.now(),data:n};return e===`progress`&&localStorage.setItem(`resume:${this.namespace}`,`true`),localStorage.setItem(`${this.namespace}:${e}`,JSON.stringify(r)),t(),!0}catch(n){console.error(`Save failed:`,n);try{return e===`progress`&&sessionStorage.setItem(`resume:${this.namespace}`,`true`),sessionStorage.setItem(`${this.namespace}:${e}`,JSON.stringify(payload)),t(),!0}catch{return!1}}}load(e){try{let t=`resume:${this.namespace}`,n=localStorage.getItem(`${this.namespace}:${e}`),r=sessionStorage.getItem(`${this.namespace}:${e}`),i=n||r,a=sessionStorage.getItem(t)===`true`||localStorage.getItem(t)===`true`||!!n;if(e===`progress`&&!a||!i)return null;e===`progress`&&!sessionStorage.getItem(t)&&!localStorage.getItem(t)&&localStorage.setItem(t,`true`);let o=JSON.parse(i);return o.version===this.version?(e===`progress`&&a&&sessionStorage.removeItem(t),o.data):this.migrate(o)}catch(e){return console.error(`Load failed:`,e),null}}migrate(e){return console.log(`Migrating from ${e.version} to ${this.version}`),e.data}clear(e){if(!e){Object.keys(localStorage).filter(e=>e.startsWith(`${this.namespace}:`)).forEach(e=>localStorage.removeItem(e)),Object.keys(sessionStorage).filter(e=>e.startsWith(`${this.namespace}:`)).forEach(e=>sessionStorage.removeItem(e)),localStorage.removeItem(`resume:${this.namespace}`),sessionStorage.removeItem(`resume:${this.namespace}`);return}localStorage.removeItem(`${this.namespace}:${e}`),sessionStorage.removeItem(`${this.namespace}:${e}`),e===`progress`&&(localStorage.removeItem(`resume:${this.namespace}`),sessionStorage.removeItem(`resume:${this.namespace}`))}export(){let e={};for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);n&&n.startsWith(this.namespace)&&(e[n]=localStorage.getItem(n))}return JSON.stringify(e,null,2)}},c={errors:[],logError(e,t=``){let n={timestamp:new Date,message:e.message,stack:e.stack,context:t};this.errors.push(n),console.error(`[${t}] Assessment Error:`,e)},showUserError(e,t=null){let n=document.querySelector(`.user-error`);n&&n.remove();let r=document.createElement(`div`);return r.className=`user-error`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`assertive`),r.innerHTML=`
      <span>⚠️ ${o.sanitizeHTML(e)}</span>
      <button onclick="this.parentElement.remove()" aria-label="Dismiss error message">×</button>
    `,(t||document.querySelector(`.assessment-container`)||document.body).appendChild(r),setTimeout(()=>{r.remove()},5e3),r.focus(),r},clearErrors(){this.errors=[]}},l={createElement(e,t={},n=[]){let r=document.createElement(e);for(let[e,n]of Object.entries(t))e===`style`&&typeof n==`object`?Object.assign(r.style,n):e===`className`?r.className=n:e.startsWith(`data-`)?r.setAttribute(e,n):r[e]=n;return typeof n==`string`?r.textContent=n:Array.isArray(n)&&n.forEach(e=>{typeof e==`string`?r.appendChild(document.createTextNode(e)):e instanceof Node&&r.appendChild(e)}),r},focusElement(e,t={}){e&&(e.focus({preventScroll:t.preventScroll||!1}),t.preventScroll||e.scrollIntoView({behavior:`smooth`,block:`center`}))}},u=`1.1.0`,d={diagnosis:[`Sovereign of Mind`,`Distortion Codex`],coaching:[`Belief Mastery`,`Sovereign of Mind`],"life-domain-review":[`Belief Mastery`,`Sovereign of Mind`],manipulation:[`Sovereign of Mind`,`Distortion Codex`],channels:[`Sovereign of Mind`],paradigm:[`Sovereign of Mind`],"sovereignty-spectrum":[`Sovereign of Mind`],sovereignty:[`Sovereign of Mind`],"needs-dependency":[`Belief Mastery`,`Sovereign of Mind`],"logos-structure":[`Sovereign of Mind`],"cognitive-resistance-capacity":[`Sovereign of Mind`],"cognitive-resistance-capacity-assessment":[`Sovereign of Mind`],"sovereignty-paradigm":[`Sovereign of Mind`],"sovereignty-spectrum-analysis":[`Sovereign of Mind`],entities:[`Sovereign of Mind`],"outlier-aptitude":[`Sovereign of Mind`]},f={"life-domain-review":`coaching`,"logos-structure":`paradigm`,"cognitive-resistance-capacity":`sovereignty`,"cognitive-resistance-capacity-assessment":`sovereignty`,"sovereignty-spectrum-analysis":`sovereignty-paradigm`};function p(e){return e&&(f[e]||e)}function m(e){return e&&d[e]||[`Belief Mastery`,`Sovereign of Mind`]}function h(e,t,n=3){return e.filter(e=>typeof e[t]==`number`).sort((e,n)=>n[t]-e[t]).slice(0,n)}function g(e){let t=[];return e?(Array.isArray(e.identifiedVectors)&&e.identifiedVectors.length&&h(e.identifiedVectors,`weightedScore`).forEach(e=>{t.push(`Manipulation vector: ${e.name} (${e.weightedScore?.toFixed?.(2)||e.weightedScore})`)}),e.obstacles&&typeof e.obstacles==`object`&&h(Object.values(e.obstacles||{}),`weightedScore`).forEach(e=>{t.push(`Sovereignty obstacle: ${e.name} (${e.weightedScore?.toFixed?.(2)||e.weightedScore})`)}),e.domains&&typeof e.domains==`object`&&Object.values(e.domains||{}).filter(e=>typeof e.combinedScore==`number`).sort((e,t)=>e.combinedScore-t.combinedScore).slice(0,2).forEach(e=>{t.push(`Life domain strain: ${e.name} (${e.combinedScore?.toFixed?.(1)||e.combinedScore}/10)`)}),e.probabilities&&typeof e.probabilities==`object`&&h(Object.entries(e.probabilities).map(([e,t])=>({name:e,value:t})).filter(e=>typeof e.value==`number`),`value`).forEach(e=>{t.push(`Diagnostic indicator: ${e.name} (${Math.round(e.value*100)}%)`)}),e.primaryPattern&&t.push(`Primary pattern: ${e.primaryPattern}`),e.primaryLoop&&(t.push(`Primary dependency loop: ${e.primaryLoop}`),e.needChainDisplay&&t.push(`Need chain (Loop ← Root): ${e.needChainDisplay}`),e.firstLinkInChain&&t.push(`First link in chain (immanent focus): ${e.firstLinkInChain}`)),e.quadrants&&typeof e.quadrants==`object`&&Object.entries(e.quadrants).forEach(([e,n])=>{n&&n.label&&t.push(`Sovereign Assessment ${e}: ${n.label}`)}),e.spectrumLabel&&t.push(`Paradigm integration level: ${e.spectrumLabel}`),t):t}function _(e,t,n){let r=m(t).join(`, `),i=g(e),a=[`Focus on the top 1–3 findings before expanding scope.`,`Use the full export for AI-guided action planning.`,`Re-run the assessment after applying corrective actions.`],o=`${n} — Executive Brief\n`;return o+=`Version: ${u}\n`,o+=`Generated: ${new Date().toISOString()}\n`,o+=`Frameworks: ${r}\n\n`,o+=`Key Findings:
`,i.length?i.forEach(e=>{o+=`- ${e}\n`}):o+=`- No dominant findings detected. Review the full report for detail.
`,o+=`
Next Actions:
`,a.forEach(e=>{o+=`- ${e}\n`}),o}function v(e,t,n){let r=p(t),i=`${n} Assessment Profile\n`;return i+=`Export Version: ${u}\n`,i+=`Generated: `+new Date().toISOString()+`
`,i+=`System Type: `+t+`
`,i+=`Frameworks: `+m(t).join(`, `)+`
`,i+=`
...
`,i+=`
`,r===`coaching`?i+=y(e):r===`manipulation`?i+=b(e):r===`channels`?i+=x(e):r===`paradigm`?i+=S(e):r===`diagnosis`?i+=C(e):r===`needs-dependency`?i+=T(e):r===`sovereignty`||r===`sovereignty-analysis`?i+=D(e):r===`sovereignty-paradigm`&&(i+=E(e)),i+=`
...
`,i+=`
`,i}function y(e){let t=`=== COACHING PROFILE DATA ===
...
`,e.secondaryConsiderations.forEach(e=>{t+=`"${e.name}",${e.probability}%,${e.severity||`Not specified`}\n`})),t}function w(e){return e==null||e===``?`Not answered`:typeof e==`object`?e.mapsTo&&e.mapsTo.need?e.mapsTo.need:e.text?e.text:Array.isArray(e)?e.map(e=>w(e)).join(`; `):JSON.stringify(e):String(e)}function T(e){let t=`=== NEEDS DEPENDENCY LOOP DETERMINATOR DATA (4-Phase Architecture) ===
`;if(e.questionSequence&&e.questionSequence.length>0&&(t+=`
=== ALL QUESTIONS AND ANSWERS ===
`,t+=`Question ID,Question Text,Answer,Phase,Loop
`,e.questionSequence.forEach(n=>{let r=w(n.answer===void 0?e.allAnswers&&e.allAnswers[n.id]:n.answer),i=(n.question||n.questionText||``).replace(/"/g,`""`);t+=`"${n.id}","${i}","${String(r).replace(/"/g,`""`)}",${n.phase||``},"${(n.loop||``).replace(/"/g,`""`)}"\n`})),e.primaryLoop){t+=`
...
`;function A(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function j(e){let t=new TextEncoder().encode(e),n=``;for(let e=0;e<t.length;e++)n+=String.fromCharCode(t[e]);let r=btoa(n),i=[];for(let e=0;e<r.length;e+=76)i.push(r.slice(e,e+76));return i.join(`\r
`)}function M(e={}){let{title:t=`Assessment report`,filenameBase:n=`report`,rootSelector:r,rootSelectors:i}=e,a=i?Array.isArray(i)?i:[i]:r?[r]:[];if(!a.length||typeof document>`u`)return!1;let o=[];for(let e of a){let t=document.querySelector(e);if(!t)continue;let n=t.cloneNode(!0);n.querySelectorAll(`button, .export-section, [data-no-export], script, style[data-live-only]`).forEach(e=>{e.remove()}),o.push(`<div class="report-export-section">${n.innerHTML}</div>`)}if(!o.length)return!1;let s=A(t),c=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<body>
<h1>${s}</h1>
<p class="report-export-meta">Exported ${A(new Date().toISOString())}</p>
${o.join(`
`)}
</body>
</html>`,l=String(n).replace(/[^a-z0-9-_]+/gi,`_`).replace(/^_|_$/g,``)||`report`,u=`BMReport_${Date.now()}_${Math.random().toString(36).slice(2,10)}`,d=`file:///C:/${l}.html`,f=String(t).replace(/[\r\n]+/g,` `).slice(0,200),p=j(c);return N([`From: <Saved by Belief Mastery>`,`Snapshot-Content-Location: ${d}`,`Subject: ${f}`,`Date: ${new Date().toUTCString()}`,`MIME-Version: 1.0`,`Content-Type: multipart/related; type="text/html"; boundary="${u}"`,``,`--${u}`,`Content-Type: text/html; charset=utf-8`,`Content-Transfer-Encoding: base64`,`Content-Location: ${d}`,``,p,``,`--${u}--`,``].join(`\r
`),`${l}.mhtml`,`multipart/related`),!0}function N(e,t,n){let r=new Blob([e],{type:n}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}var P=`
...
`;function F(){if(document.getElementById(`confirm-modal-styles`))return;let e=document.createElement(`style`);e.id=`confirm-modal-styles`,e.textContent=P,document.head.appendChild(e)}function I(e){F();let{message:t,title:n=`Confirm`,confirmLabel:r=`OK`,cancelLabel:i=`Cancel`,isAlert:a=!1}=e,o=document.createElement(`div`);o.className=`confirm-modal-backdrop`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`true`),o.setAttribute(`aria-labelledby`,`confirm-modal-title`);let s=document.createElement(`div`);s.className=`confirm-modal-box`;let c=document.createElement(`h4`);c.id=`confirm-modal-title`,c.textContent=n;let l=document.createElement(`p`);l.textContent=t;let u=document.createElement(`div`);return u.className=`confirm-modal-actions`,new Promise(e=>{let t=t=>{o.remove(),e(t)},n=document.createElement(`button`);if(n.className=`confirm-modal-btn confirm-modal-btn-primary`,n.textContent=r,n.addEventListener(`click`,()=>t(!0)),a)u.appendChild(n);else{let e=document.createElement(`button`);e.className=`confirm-modal-btn confirm-modal-btn-secondary`,e.textContent=i,e.addEventListener(`click`,()=>t(!1)),u.appendChild(e),u.appendChild(n)}o.addEventListener(`click`,e=>{e.target===o&&t(!1)}),s.appendChild(c),s.appendChild(l),s.appendChild(u),o.appendChild(s),document.body.appendChild(o),n.focus()})}function L(e){return I({message:e,title:`Confirm`,confirmLabel:`OK`,cancelLabel:`Cancel`,isAlert:!1})}function R(e){return I({message:e,title:`Notice`,confirmLabel:`OK`,isAlert:!0})}var z=class{constructor(e={}){this.config=e,this.hiddenClass=e.hiddenClass||`hidden`,this.activeClass=e.activeClass||`active`}transition(e){let t=this.config[e];t&&(this.applySelectors(t.show,!0),this.applySelectors(t.hide,!1))}applySelectors(e,t){e&&(Array.isArray(e)?e:[e]).forEach(e=>{let n=typeof e==`string`?document.querySelector(e):e;n&&(t?(n.classList.remove(this.hiddenClass),n.classList.add(this.activeClass)):(n.classList.add(this.hiddenClass),n.classList.remove(this.activeClass)))})}};function B(e,t={}){e.externalUI=!!t.externalUI,e._spaNotify=typeof t.onNotify==`function`?t.onNotify:null,e._spaPhase=e._spaPhase||`idle`,e._externalQuestionSnapshot=e._externalQuestionSnapshot??null}function V(e,t,n){try{e._spaNotify?.(t,n)}catch(e){console.warn(`Engine SPA notify:`,e)}}function H(e,t){e._spaPhase=t,V(e,`phase`,{phase:t})}function U(e){return typeof document>`u`||document.body?.dataset?.bmLegacyPage!==`true`?!1:!!(e&&document.getElementById(e))}function W(e,t){let n=()=>t();document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,n):n()}export{o as _,H as a,L as c,_ as d,v as f,c as g,s as h,V as i,N as l,l as m,W as n,z as o,O as p,U as r,R as s,B as t,M as u,a as v,i as y};